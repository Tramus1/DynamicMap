...
function createDynamicSVG(point, sectorColor) {
    ...
    const svg = `
        <svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" viewBox="0 0 16.933333 16.933333">
          ...
          <path id="Walls" d="M 5.0002116,8.0000285 V 13.00024 H 11.999784 V 8.0000285 Z" style="fill:${sectorColor};stroke-width:0.264583" />
          <path id="Roof" d="M 8.0000285,2.9998169 7.0000895,3.9997559 3.9997559,7.0000895 H 8.0000285 13.00024 L 9.9999064,3.9997559 8.9999674,2.9998169 H 8.5002563 Z" style="fill:${sectorColor};stroke-width:0.264583" />
        </svg>
    `;
    return svg;
}
